...
<body>
            ...
            <a href="user.html"> <!-- 建議直接導入登入頁面 -->
                ...
                <%
                    ...
                    try {
                        ...
                        // SQL查詢語句
                        String sql = "SELECT id, phone, email FROM members";
    ...
    <div class="login-signup">
        <form action="check.jsp" method="POST" class="login">
            <h1>會員中心</h1>
            <div>用戶名：<%= rs.getString("id") %> </div>
            <div>電話：<%= rs.getString("phone") %> </div>
            <div>電子郵件：<%= rs.getString("email") %> </div>
